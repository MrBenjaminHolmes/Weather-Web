...
function displayCurrent(data) {
  ...
  mainDiv.innerHTML = `
      <h1 class="location">${data.resolvedAddress}</h1>
        ...
        <div class="wind">Wind:${data.currentConditions.windspeed}</div>
        <div class="humidity">${data.currentConditions.humidity}:10%</div>
